...
class C(BaseConstants):
    ...
    privacy_note = 'ВНИМАНИЕ: В любом случае <b>только вы</b> можете видеть ответ участника Б на этот вопрос. Участник Б не имеет возможности посмотреть ваши ответы на какие-либо вопросы. '
